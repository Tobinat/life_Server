...
fnc_setupFuncs = {
    ...
    life_publicVarList = ["truckStorageExtension","speedtrap","speedtrapGetPhotoList","speedtrapActivate","speedtrapSetSpeedLimit","speedtrapRemove","speedtrapAdd","trapped","trappedFlash","setSpeedtrapLimit"];
